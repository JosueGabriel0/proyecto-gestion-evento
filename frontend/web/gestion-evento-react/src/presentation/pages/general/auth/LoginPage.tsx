...
const LoginPage: React.FC = () => {
  ...
  const [pupilPosition] = useState<PupilPosition>({ x: "50%", y: "50%" });
  ...
  const classNameEye = `${LoginPageCSS.eye} 
                   ${isClosed ? LoginPageCSS.closed : ""} 
                   ${isBlinking ? LoginPageCSS.blink : ""}`.trim();
          ...
          <div className={LoginPageCSS["login-container-1"]}>
                  ...
                  <div className={LoginPageCSS["input-wrapper"]}>
                    ...
                    >
                      <div className={classNameEye}>
                        {!isClosed && <div className={LoginPageCSS["pupil"]} style={{ left: pupilPosition.x, top: pupilPosition.y }}><div className={LoginPageCSS["pupil-reflection"]}></div></div>}
                      </div>
                    </button>
                    <input
            ...
            <div className={LoginPageCSS["card"]}>
              <a className={LoginPageCSS["social-link1"]}>
                <svg style={{ color: 'white' }} xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className={LoginPageCSS["bi bi-instagram"]} viewBox="0 0 16 16">
              ...
              <a className={LoginPageCSS["social-link2"]}>
              ...
              <a className={LoginPageCSS["social-link3"]}>
                <svg style={{ color: 'white' }} xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className={LoginPageCSS["bi bi-discord"]} viewBox="0 0 16 16">
              ...
              <a className={LoginPageCSS["social-link4"]}>
              ...
              <a className={LoginPageCSS["social-link5"]}>
                <svg viewBox="0 0 16 16" className={LoginPageCSS["bi bi-stack-overflow"]} fill="currentColor" height={16} width={16} xmlns="http://www.w3.org/2000/svg">
